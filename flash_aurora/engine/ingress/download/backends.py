...
from flash_aurora.engine.ingress.download import cds, layout, mars, weatherbench2
...
DEFAULT_BACKENDS: dict[str, DownloadBackend] = {
    ...
    "cams": UnsupportedBackend(
        "CAMS",
        doc="Download from ADS manually (see aurora/docs/example_cams.ipynb).",
    ),
