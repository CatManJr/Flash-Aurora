...
def _split_cute_bnc_from_qkv(
    ...
    *,
    ...
    from flash_aurora.models.ops.cute import window_attn_fwd_cute
...
def _patch_window_attention(
    ...
    *,
    ...
    from flash_aurora.models.aurora.model import swin3d
    ...
    from flash_aurora.models.ops.cute import WinAttnPrecision, window_attn_fwd_cute, window_attn_fwd_cute_qkvpacked
